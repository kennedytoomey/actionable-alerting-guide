...
function initializeAnimations() {
    const animatedElements = document.querySelectorAll(
        '.overview-card, .comparison-card, .customization-card, .practice-card, .tool-card, .ai-capability, .vision-card, .roadmap-step, .impact-stat, .feature-category, .benefit-item, .datadog-hero-card, .author-card, .blog-post-card'
    );
